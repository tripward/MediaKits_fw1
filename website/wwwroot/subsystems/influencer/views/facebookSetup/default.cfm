...
<a href="#rc.facebookConnection.buildRedirectToAuthURL( state='#session.surfer.getinfluencerAccountID()#', scope=rc.aScope )#">Login and Authenticate</a>


<!---<form action="/index.cfm?action=influencer:facebook.getFBID" role="form" method="post" enctype="multipart/form-data">
