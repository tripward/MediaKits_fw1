...
component displayname="InfluencerPressLinksService" persistent="false" accessors="true" output="false" extends="baseService" {
	...
	property name='ObjectType' type="string" default="conferences";
	property name='tableName' type="string" default="conferences";
	property name='ObjectIDProp' type="string" default="conferenceid";
