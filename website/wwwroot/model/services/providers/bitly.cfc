component extends="model.services.oauth2" accessors="true" {
	...
	/**
	* I return an initialized bitly object instance.
	...
	**/
	public bitly function init(
		required string client_id, 
		required string client_secret, 
		required string authEndpoint = 'https://bitly.com/oauth/authorize', 
		required string accessTokenEndpoint = 'https://api-ssl.bitly.com/oauth/access_token',
