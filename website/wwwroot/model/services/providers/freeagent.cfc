component extends="model.services.oauth2" accessors="true" {
	...
	/**
	* I return an initialized freeagent object instance.
	...
	**/
	public freeagent function init(
		required string client_id, 
		required string client_secret, 
		required string authEndpoint = 'https://api.freeagent.com/v2/approve_app', 
		required string accessTokenEndpoint = 'https://api.freeagent.com/v2/token_endpoint',
